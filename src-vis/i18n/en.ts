...
export const en: Record<TranslationKey, string> = {
  ...
  'wizard.tab.selectMethod':  'Choose how you want to create the new tab.',
  'wizard.tab.byTopic':       'By Topic',
  'wizard.tab.byTopicHint':   'Search for "Light", "Heating", etc. and select matching datapoints.',
  'wizard.tab.home':          'Home',
  'wizard.tab.homeHint':      'Automatic overview with time, temperature, light and other relevant values.',
  'wizard.tab.topicLight':    'Light',
  'wizard.tab.topicHeating':  'Heating',
  'wizard.tab.topicEnergy':   'Energy',
  'wizard.tab.topicClimate':  'Climate',
  'wizard.tab.topicBlinds':   'Blinds',
  'wizard.tab.topicSockets':  'Sockets',
  'wizard.tab.topicSecurity': 'Security',
  'wizard.tab.whatToShow':    'What should be shown on this tab?',
  'wizard.tab.topicPh':       'e.g. Light, Heating, Energy …',
  'wizard.tab.suggestions':   'Suggestions',
  'wizard.tab.loadingDp':     'Loading datapoints…',
  'wizard.tab.foundDp':       '{count} matching datapoints found',
  'wizard.tab.noDp':          'No matching datapoints – try a different keyword',
  'wizard.tab.dpFound':       'datapoints found',
  'wizard.tab.selected':      'selected',
  'wizard.tab.allFrom':       'All from',
  'wizard.tab.allOn':         'All on',
  'wizard.tab.filter':        'Filter…',
  'wizard.tab.noResults':     'No results',
  'wizard.tab.grouping':      'Should the {count} widgets be grouped by room or function?',
  'wizard.tab.groupNone':     'None',
  'wizard.tab.groupNoneHint': 'All widgets in a row',
  'wizard.tab.groupRoom':     'Room',
  'wizard.tab.groupRoomHint': 'By ioBroker rooms',
  'wizard.tab.groupFunc':     'Function',
  'wizard.tab.groupFuncHint': 'By ioBroker functions',
  'wizard.tab.noData':        'No data available',
  'wizard.tab.widget':        'Widget',
  'wizard.tab.widgets':       'Widgets',
  'wizard.tab.groups':        'Groups',
  'wizard.tab.rooms':         'Rooms',
  'wizard.tab.functions':     'Functions',
  'wizard.tab.readingDp':     'Reading datapoints…',
  'wizard.tab.foundHomeDp':   '{count} relevant datapoints found for the home page.',
  'wizard.tab.noHomeDp':      'No relevant datapoints found. Make sure ioBroker adapters are connected.',
  'wizard.tab.tabName':       'Tab Name',
  'wizard.tab.homeDefault':   'Home',
